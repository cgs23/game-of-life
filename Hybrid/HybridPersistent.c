...
{
    int dimension, generation, rank, numOfProcesses, blockDimension, i, j, w, z, x, y, r;
    ...
    #pragma omp parallel private(i)
        for(i=0; i < generation; i++)
        {
            ...
            #pragma omp for private(x, y, w, z, neighbors) collapse(2) reduction(||:alive, different) schedule(static, (blockDimension-2)/2)
            ...
            #pragma omp for private(x, w, z, neighbors) reduction(||:alive, different) schedule(static, blockDimension/2)
